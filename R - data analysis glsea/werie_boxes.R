...
nc = nc_open('annual.micro.werie.nc', write=FALSE, readunlim =FALSE)
...
pdf(file='maumee_5p_all.pdf', width=11, height=8.5, onefile=FALSE)
plot_grid(p.mb.first, p.mb.last, p.mb.mgr, p.mb.gd, p.mb.gs, 
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
dev.off()

pdf(file='werie_5p_all.pdf', width=11, height=8.5, onefile=FALSE)
plot_grid(p.we.first, p.we.last, p.we.mgr, p.we.gd, p.we.gs, 
          labels = c("A", "B", "C", "D", "E"),
          ncol = 3, nrow = 2)
dev.off()

pdf(file='sand_5p_all.pdf', width=11, height=8.5, onefile=FALSE)
