...
# Updated by Grace Di Cecco, 1/3/23
...
fixed.thresh = 0.5612943 #preturbation run, 22 C growth rate
...
for(i in 1:length(fnames)){
  ...
  outdir <- 'output_data/'
  ncfname <- paste(outdir,"micro-growth-werie-th22",year,".nc",sep="")
...
# create netCDF file and put arrays
outdir <- 'output_data/'
ncfname <- paste(outdir,"annual.micro.werie.th22.nc",sep="")
