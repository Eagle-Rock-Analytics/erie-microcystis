#Owen Doherty
#August 6, 2018 - Set threshold at 17 C
# Updated by Grace Di Cecco, 1/10/23
...
fixed.thresh = 0.2901488 #preturbation run, 17 C growth rate
...
for(i in 1:length(fnames)){
  ...
  outdir <- 'output_data/'
  ncfname <- paste(outdir,"micro-growth-werie-th17",year,".nc",sep="")
...
# create netCDF file and put arrays
outdir <- 'output_data/'
ncfname <- paste(outdir,"annual.micro.werie.th17.nc",sep="")
