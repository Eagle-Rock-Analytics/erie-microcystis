...
keep4 = c("Gobler-2h","Gobler-2l","Gobler-3h","Gobler-3l","Coles & Jones 2000a","Kruger & Eloff 1978a")
...
pdf("first_resampled.pdf") 
  ...
  ylab('growth rate') + ylim(-0.05,0.5)+
